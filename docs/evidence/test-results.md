...
I investigated this issue and found it stemmed from the following code in Game.kt:
```kotlin
/**
...
```
We check for a valid item before adding it to our inventory but we can remove it from the map here as well.
