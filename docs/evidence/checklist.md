...
- [x] **Variables** of at lright two types (e.g. int, text, boolean)
...
- [ ] Procedures are **efficient** (minimal iterations, etc.) _there are too many .find {} for me to feel good checking this_
